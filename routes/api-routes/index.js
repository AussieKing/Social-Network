...
router.use('/users', userRoutes);  // add prefix of `/users` to all of the user routes imported from the `user-routes.js` file
router.use('/thoughts', thoughtRoutes);  // add prefix of `/thoughts` to all of the thought routes imported from the `thought-routes.js` file
